...
public class GameLevelPage {
	...
	private void initialize() {
		...
		JLabel lblAddBlockError = new JLabel("add block error");
		lblAddBlockError.setFont(new Font("Monospaced", Font.PLAIN, 10));
											...
											.addGroup(groupLayout.createSequentialGroup()
												...
												.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
													.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
														...
														.addGroup(groupLayout.createSequentialGroup()
															.addGap(95)
															.addComponent(lblAddBlockError, GroupLayout.PREFERRED_SIZE, 247, GroupLayout.PREFERRED_SIZE)
															.addContainerGap()))
													.addGroup(groupLayout.createSequentialGroup()
														.addGap(155)
														.addComponent(btnAdd)
