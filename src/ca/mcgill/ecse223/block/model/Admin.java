...
public class Admin extends UserRole implements Serializable
{
  ...
  public Game addGame(boolean aIsPublished, String aName, int aNrBlocksPerLevel, Ball aBall, Paddle aPaddle, HallOfFame aHallOfFame, Block223 aBlock223)
  {
    return new Game(aIsPublished, aName, aNrBlocksPerLevel, this, aBall, aPaddle, aHallOfFame, aBlock223);
  }
